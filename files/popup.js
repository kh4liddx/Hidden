// Event listener for the popup closure
    ...
    function popup1() {
        CreativaPopup.create('Feel free to DM me KH4LIDDX', 'Tele');
    }
    ...
    function popup13() {
CreativaPopup.create('Feel free to contact me on Telegram <font class="contactding" onclick="allahm109kd(); allahm109kd2();" color="#FF0000">KH4LIDDX</font> :)<br> <font style="color: #696969; font-size: smaller;"> or use my discord server <a href="https://discord.gg/wbWBxg6kCg" style="color: #ADD8E6;">https://discord.gg/wbWBxg6kCg</a> </font>', 'Discord', '', { titleColor: '#6ffcff', textColor: '#b0b0b0' });

    }

    function allahm109kd() {
        navigator.clipboard.writeText("@KHLIDDX");
        setTimeout(function(){
        alert("Tele username was copied to the clipboard");
        }, 50);
    }
    function allahm109kd1() {
        navigator.clipboard.writeText("@KH4LIDDX");
        setTimeout(function(){
        alert("Tele username was copied to the clipboard");
        }, 50);
    }
